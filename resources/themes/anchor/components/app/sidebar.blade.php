...
<!--                </div>-->
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    <x-app.sidebar-link href="/dashboard" icon="/themes/buraleasy/planet.svg" :active="Request::is('dashboard')">Dashboard</x-app.sidebar-link>
                    <x-app.sidebar-link href="/store/details" icon="/themes/buraleasy/verified.svg" :active="Request::is('store.details')">Mon magasin</x-app.sidebar-link>
                </div>
            </div>
